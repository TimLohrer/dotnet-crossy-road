        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    taler = table.Column<int>(type: "integer", nullable: false),
                    skin = table.Column<int>(type: "integer", nullable: false),
                    owned_skins = table.Column<int[]>(type: "integer[]", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    crossy_game_id = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("pk_crossy_players", x => x.user_id);
                    table.ForeignKey(
                        name: "fk_crossy_players_crossy_games_crossy_game_id",
                        column: x => x.crossy_game_id,
